...
#'
#' @description The binary transformation methods require a specific data format from
#'  base classifiers prediction this is used to transform the result from the base
#'  methods.
#'
