# This file contains functions related with sampling The most function are available public in the package The functions are sorted in alphabetical order
